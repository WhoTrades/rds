...
class ServiceRdsProdTL1
{
    ...
    protected function getAllCommands()
    {
        return [
            ...
            new MultiCommandToCron(new MultiPeriodicCommand(\PgQ_EventProcessor_RdsJiraNotificationQueue::getPgqConsumer('rds_jira_notification_queue', 'rds_jira_notification_queue_consumer', 'simple', 'DSN_DB4', 1, [], 3), 5), '* * * * *'),
        ];
    }
