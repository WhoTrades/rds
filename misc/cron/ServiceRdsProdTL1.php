...
class ServiceRdsProdTL1
{
    ...
    protected function getAllCommands()
    {
        return [
            ...
            new MultiCommandToCron(\PgQ_EventProcessor_RdsJiraCreateVersion::getPgqConsumer('rds_jira_create_version', 'rds_jira_create_version_consumer', 'simple', 'DSN_DB4', 1, [], 3), '* * * * * *', 'rds_jira_create_version'),
            new MultiCommandToCron(\PgQ_EventProcessor_RdsJiraCommit::getPgqConsumer('rds_jira_commit', 'rds_jira_commit_consumer', 'simple', 'DSN_DB4', 1, [], 3), '* * * * * *', 'rds_jira_commit'),
            ...
            new MultiCommandToCron(\PgQ_EventProcessor_JiraMoveTicket::getPgqConsumer('rds_jira_async_rpc_queue', 'rds_jira_async_rpc_queue_consumer', 'simple', 'DSN_DB4', 1, [], 3), '* * * * * *', 'rds_jira_async_rpc'),
            ...
            new MultiCommandToCron(\PgQ_EventProcessor_RdsTeamCityRunTest::getPgqConsumer('rds_teamcity_run_test', 'rds_teamcity_run_test_consumer', 'simple', 'DSN_DB4', 1, [], 3), '* * * * * *', 'rds_teamcity_run_test'),
            new MultiCommandToCron(\PgQ_EventProcessor_RdsTeamCityBuildComplete::getPgqConsumer('rds_teamcity_build_complete', 'rds_teamcity_build_complete_consumer', 'simple', 'DSN_DB4', 1, [], 3), '* * * * * *', 'rds_teamcity_build_complete'),
            ...
            new MultiCommandToCron(\PgQ_EventProcessor_ProcessCreatePullRequest::getPgqConsumer('rds_create_pull_request', 'rds_create_pull_request_consumer', 'simple', 'DSN_DB4', 1, [], 3), '* * * * * *', 'rds_create_pull_request'),
