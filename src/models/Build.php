...
class Build extends ActiveRecord
{
    ...
    public function determineHumanReadableError()
    {
        $regexes = [
            ...
            '~ process=dump, status=sent, target=sentry, target=raven, event_id=(\w+)~' => "Sentry <a href='https://sentry.whotrades.com/sentry/{$this->project->project_name}/?query=$1'><b>$1</b></a>. ",
        ];
