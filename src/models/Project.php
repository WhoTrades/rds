...
class Project extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['script_migration_up', 'script_migration_new', 'script_config_local', 'script_remove_release', 'script_cron', 'script_deploy', 'script_post_deploy', 'script_build', 'script_use'], 'string'],
