...
return [
    ...
    'script_migration_up' => 'PRE/POST migrations runner script',
    'script_migration_up_hard' => 'HARD migrations runner script',
    ...
    'help_migration_runner' => 'Script should run PRE/POST migrations. In case of error script should exit with exit-code != 0',
    'help_migration_hard_runner' => 'Script should run HARD migrations.',
