...
<div class="view">
	...
	<b><?php echo \yii\helpers\Html::encode($data->getAttributeLabel('build_release_request_obj_id')); ?>:</b>
	<?php echo \yii\helpers\Html::encode($data->build_release_request_obj_id); ?>
	<br />

	<b><?php echo \yii\helpers\Html::encode($data->getAttributeLabel('build_worker_obj_id')); ?>:</b>
	<?php echo \yii\helpers\Html::encode($data->build_worker_obj_id); ?>
	<br />

	<b><?php echo \yii\helpers\Html::encode($data->getAttributeLabel('build_project_obj_id')); ?>:</b>
	<?php echo \yii\helpers\Html::encode($data->build_project_obj_id); ?>
	<br />
